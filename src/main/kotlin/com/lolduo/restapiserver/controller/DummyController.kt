...
class DummyController {
    ...
    @GetMapping("/soloDetailDummy")
    @ApiOperation(value = "솔로 랭크 상세 정보 더미 데이터", notes = "솔로 랭크 상세 정보 더미 데이터를 반환합니다.", response = DetailSoloResponse::class)
    fun getSoloChampionDetailDummy(): ResponseEntity<*>? {
        ...
        val detailRankWinRate2 = DetailRankWinRate(2L, "65.1%")
        val detailRankWinRate3 = DetailRankWinRate(3L, "60.1%")
        val detailSolo1 = DetailSolo(detailRankWinRate1, detailInfo)
        val detailSolo2 = DetailSolo(detailRankWinRate2, detailInfo)
        val detailSolo3 = DetailSolo(detailRankWinRate3, detailInfo)
        val detailSoloList: MutableList<DetailSolo> = ArrayList<DetailSolo>()
        detailSoloList.add(detailSolo1)
        detailSoloList.add(detailSolo2)
        detailSoloList.add(detailSolo3)
        val detailSoloResponse = DetailSoloResponse(detailChampionComp, detailSoloList)
        return ResponseEntity<Any>(detailSoloResponse, HttpStatus.OK)
    }

    @GetMapping("/dummyDuoDetail")
    @ApiOperation(value = "더미 데이터", notes = "더미 데이터", response = DetailDoubleResponse::class)
    fun getDoubleChampionDetailDummy(): ResponseEntity<*>? {
        val baseUrl = "https://lol-duo-bucket.s3.ap-northeast-2.amazonaws.com/Rune/"
        val championName = "미스 포츈"
        val championImgUrl = "https://d2d4ci5rabfoyr.cloudfront.net/mainPage/champion/MissFortune.svg"
        val mainRuneImgUrl = "https://d2d4ci5rabfoyr.cloudfront.net/mainPage/mainRune/LethalTempoTemp.svg"
    ...
    fun getSoloDummy(): ResponseEntity<*>? {
        ...
        val soloResponse2 = SoloResponseV2(
            2,
            1,
            "미스 포츈",
            "https://d2d4ci5rabfoyr.cloudfront.net/mainPage/champion/MissFortune.svg",
        ...
        val soloResponse3 = SoloResponseV2(
            3,
            2,
            "미스 포츈",
            "https://d2d4ci5rabfoyr.cloudfront.net/mainPage/champion/MissFortune.svg",
        ...
        val soloResponse4 = SoloResponseV2(
            4,
            3,
            "미스 포츈",
            "https://d2d4ci5rabfoyr.cloudfront.net/mainPage/champion/MissFortune.svg",
        ...
        val soloResponseArray = arrayOf(soloResponse1, soloResponse2, soloResponse3, soloResponse4)
        return ResponseEntity<Any>(soloResponseArray, HttpStatus.OK)
    }
}